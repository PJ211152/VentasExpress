    ...
    public partial class Formulario_interno : Form
    {
        ...
        private void btn_Consultar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txb_Consultar.Text == "huevos" || txb_Consultar.Text == "HUEVOS" || txb_Consultar.Text == "1")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
                ...
                if (txb_Consultar.Text == "pollo" || txb_Consultar.Text == "POllO" || txb_Consultar.Text == "2")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
                ...
                if (txb_Consultar.Text == "aceite" || txb_Consultar.Text == "ACEITE" || txb_Consultar.Text == "3")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
                ...
                if (txb_Consultar.Text == "dulces" || txb_Consultar.Text == "DULCES" || txb_Consultar.Text == "5")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
                ...
                if (txb_Consultar.Text == "fosforos" || txb_Consultar.Text == "FOSFOROS" || txb_Consultar.Text == "4" || txb_Consultar.Text == "fósforos" || txb_Consultar.Text == "FOSFÓROS")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
                ...
                if (txb_Consultar.Text == "margarina" || txb_Consultar.Text == "MARGARINA" || txb_Consultar.Text == "6")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
                ...
                if (txb_Consultar.Text == "jabón" || txb_Consultar.Text == "JABÓN" || txb_Consultar.Text == "7" || txb_Consultar.Text == "JABON" || txb_Consultar.Text == "jabon")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
                ...
                if (txb_Consultar.Text == "carne" || txb_Consultar.Text == "CARNE" || txb_Consultar.Text == "8")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
                ...
                if (txb_Consultar.Text == "gaseosa" || txb_Consultar.Text == "GASEOSA" || txb_Consultar.Text == "9")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
                ...
                if (txb_Consultar.Text == "desechables" || txb_Consultar.Text == "DESECHABLES" || txb_Consultar.Text == "10")
                {
                    dgw_Consulta.Rows.Clear();
                    int n = dgw_Consulta.Rows.Add();
